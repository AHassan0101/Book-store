            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="">
                        <img class="brand-logo" alt="e-sales logo"
                             src="{{URL::to('front-end/image/logo.png')}}">
                        <h3 class="brand-text">E-Library</h3>
                    </a>
                </li>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1">Hello,<span class="user-name text-bold-700">
                                    Admin
                                </span>
                            </span>
                            <span class="avatar avatar-online">
                                <img src="{{URL::to('app-assets/images/portrait/small/avatar-s-19.png')}}"
                                     alt="avatar"><i></i>
                            </span>
                        </a>
